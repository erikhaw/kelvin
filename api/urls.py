...
urlpatterns = [
    ...
    path("quiz/<int:quiz_id>/question/preview", views.quiz_question_preview, name="api_quiz_question_preview"),
    path("quiz/<int:enrolled_id>/result/<int:is_submit>", views.quiz_results, name="api_quiz_results"),
    path("quiz/<int:enrolled_id>/scoring", views.quiz_scoring, name="api_quiz_scoring"),
    path("quiz-list", views.quizzes_list_all, name="api_quiz_list"),
    path("quiz-list/<subject_abbr>", views.quizzes_list_all, name="api_quiz_list_subject"),
    path("quiz/<int:quiz_id>/submits", views.quiz_submits, name="api_quiz_submits_list"),
    path("quiz/<int:quiz_id>/submits/<class_id>", views.quiz_submits, name="api_quiz_submits_list_class"),
